...
export async function POST(req: Request) {
  try {
    ...
    // Check if the user is already pending or registered
    const existingQuery = query(zambaaraRef, where('mobile', '==', mobile), where('status', '==', 'pending'))
    ...
    console.error('Error registering for Zambaara tournament:', error)
