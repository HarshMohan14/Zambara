  ...
  useEffect(() => {
    ...
    if (elementsContainerRef.current) {
      ...
      Array.from(elements).forEach((el) => {
        const floatDistanceX = Math.random() * 40 - 20
        const floatDistanceY = Math.random() * 50 - 25
        const rotateAngle = Math.random() * 30 - 15
  ...
  return (
    <>
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('/tagcon_bg.png')",
          fontFamily: "'Nunito', sans-serif"
        }}
      >
        {/* Subtle Darkening Overlay on generated background */}
