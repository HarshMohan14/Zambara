...
import {
  BaseTexture,
  Texture
} from "./chunk-Y747VA22.js";
import {
  SerializationHelper
} from "./chunk-SFTMKXOI.js";
import {
  __decorate,
  serialize,
  serializeAsColor4
...
} from "./chunk-CBV755Q6.js";
import {
  EffectWrapper
} from "./chunk-BSLAIFR3.js";
import {
  GetClass,
  RegisterClass
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-BKUPFPEE.js").then((module) => this._dumpTools = module);
    }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-VFGVINHD.js");
    const textures = [];
...
//# sourceMappingURL=chunk-5GP73RUY.js.map
