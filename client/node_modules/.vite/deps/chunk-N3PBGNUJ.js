...
function _GetCompatibleTextureLoader(extension, mimeType) {
  ...
  if (!_registeredTextureLoaders.has(extension)) {
    ...
    if (extension.endsWith(".dds")) {
      registerTextureLoader(".dds", () => import("./ddsTextureLoader-D2IJ6MXA.js").then((module) => new module._DDSTextureLoader()));
    }
    if (extension.endsWith(".basis")) {
      registerTextureLoader(".basis", () => import("./basisTextureLoader-HOVHQIZ2.js").then((module) => new module._BasisTextureLoader()));
    }
    if (extension.endsWith(".env")) {
      registerTextureLoader(".env", () => import("./envTextureLoader-5ERKWGS4.js").then((module) => new module._ENVTextureLoader()));
    }
    ...
    if (extension.endsWith(".ktx") || extension.endsWith(".ktx2")) {
      registerTextureLoader(".ktx", () => import("./ktxTextureLoader-DBAPUOT5.js").then((module) => new module._KTXTextureLoader()));
      registerTextureLoader(".ktx2", () => import("./ktxTextureLoader-DBAPUOT5.js").then((module) => new module._KTXTextureLoader()));
    }
    if (extension.endsWith(".tga")) {
      registerTextureLoader(".tga", () => import("./tgaTextureLoader-5D4N4ENP.js").then((module) => new module._TGATextureLoader()));
    }
    if (extension.endsWith(".exr")) {
      registerTextureLoader(".exr", () => import("./exrTextureLoader-ZAL2Q4GF.js").then((module) => new module._ExrTextureLoader()));
    }
  }
...
//# sourceMappingURL=chunk-N3PBGNUJ.js.map
