...
export function isPointInBox(pos, min, max, margin = 0) {
...
export function isInsideStaircase(pos) {
 ...
 */
export function checkCollision(pos, doorStates, playerRadius = 0.2) {
 ...
 */
export function validateMove(oldPos, newPos, maxSpeed, deltaTime, doorStates) {
